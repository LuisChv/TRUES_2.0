...
public class dRecyclerItemTouchHelper extends ItemTouchHelper.SimpleCallback {
    ...
    public dRecyclerItemTouchHelper(int dragDirs, int swipeDirs,
    ...
    public void onSelectedChanged(@Nullable RecyclerView.ViewHolder viewHolder, int actionState) {
        if(viewHolder != null){
            View foregroundView = ((MyDocumentoRecyclerViewAdapter.ViewHolder) viewHolder).layoutABorrar;
    ...
    public void onChildDraw(@NonNull Canvas c, @NonNull RecyclerView recyclerView,
        ...
        View foregroundView = ((MyDocumentoRecyclerViewAdapter.ViewHolder) viewHolder).layoutABorrar;
        View layoutRojo = ((MyDocumentoRecyclerViewAdapter.ViewHolder) viewHolder).layoutRojo;
        View layoutAzul = ((MyDocumentoRecyclerViewAdapter.ViewHolder) viewHolder).layoutAzul;
